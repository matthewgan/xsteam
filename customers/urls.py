...
from .views import CustomerSignupView, CustomerLoginView, CustomerListView, CustomerDetailView, CustomerInfoView, CustomerPointUpdateView
...
urlpatterns = [
    ...
    url(r'^pointUpdate/$', CustomerPointUpdateView.as_view()),
]
